...
const FMTLINE = { classic:"Texas Hold'em NL", bounty:'Knockout · очки за нокауты' };
...
async function loadTours(){
  ...
  grid.innerHTML = tours.length ? tours.map((t,i)=>tcard(t, i===0)).join('') : '<p class="muted">Ближайшие турниры скоро появятся — следите за анонсами.</p>';
}
loadTours();
