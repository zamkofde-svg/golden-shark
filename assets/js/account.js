...
function startDemo() {
  ...
  el('demoLogin').addEventListener('click', () => {
    ...
    const me = {
      ...
      registrations: [
        { status: 'confirmed', title: 'Классика', starts_at: iso(2, 19), venue: 'г. Краснодар' },
        { status: 'waitlist',  title: 'Баунти',   starts_at: iso(4, 17), venue: 'г. Краснодар' },
      ],
      history: [
